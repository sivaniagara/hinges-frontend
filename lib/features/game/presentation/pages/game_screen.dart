...
class _GameScreenState extends State<GameScreen> {
              ...
              child: Column(
                ...
                children: [
                  if (gameData.breakStatus == BreakStatusEnum.strategicBreak && state.remainingSecondsToExpireBreak! > 5)
                    ...
                    PlayerRoundStartsIn(playerList: homeState.userData.players, categoryAndItemsEntity: homeState.userData.categoryAndItsItem, playerData: playerData,)
                    ...
                    AcceleratedRoundIntro()
                      ...
                      PlayerSetBreakWidget(playerList: homeState.userData.players, categoryAndItemsEntity: homeState.userData.categoryAndItsItem, playerData: playerData,)
                  else
  ...
  Widget _buildFirstColumn() {
    return Container(
      ...
      child: Column(
        ...
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          _buildSideMenu(image: AppImages.hammer, t1: 'AUCTION', t2: 'ROOM'),
  ...
  Widget _buildAuctionerSection() {
    return Column(
      spacing: 5,
      children: [
        Text('AUCTIONER', maxLines: 1, style: GoogleFonts.cinzel(color: AppTheme.borderGold, fontSize: 12, fontWeight: FontWeight.bold)),
        Image.asset(AppImages.auctioner, width: 70, height: 70),
      ],
    );
  }
  ...
  Widget _buildRemainingPurseCard(String userId) {
    return BlocSelector<GameBloc, GameState, String>(
      ...
      builder: (context, balance) => _buildTileCard(image: AppImages.purse, t1: 'PURSE REMAIN', val: balance),
    );
  }
