...
class MiniAuctionLiteRuleBookScreen extends StatefulWidget {
  const MiniAuctionLiteRuleBookScreen({super.key});

  @override
  State<MiniAuctionLiteRuleBookScreen> createState() => _RuleBookScreenState();
}

class _RuleBookScreenState extends State<MiniAuctionLiteRuleBookScreen> {
              ...
              children: [
                ...
                for (final p in section.paragraphs)
                  Padding(
                    ...
                    child: Text(
                      p,
                      style: GoogleFonts.rajdhani(color: Colors.white, fontSize: 12, height: 1.42, fontWeight: FontWeight.w500),
                    ),
                  ),
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    b,
                                    style: GoogleFonts.rajdhani(color: Colors.white, fontSize: 12, height: 1.35, fontWeight: FontWeight.w500),
                                  ),
                                ),
                              ],
                            ),
