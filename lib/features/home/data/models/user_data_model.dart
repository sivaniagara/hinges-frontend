...
class UserDataModel extends UserDataEntity {
  const UserDataModel({
    ...
    required super.miniAuctionLiteClassicPlayed,
    required super.miniAuctionLitePremiumPlayed,
    required super.miniAuctionLiteElitePlayed,
    required super.miniAuctionLiteRoyalPlayed,
  ...
  factory UserDataModel.fromJson(Map<String, dynamic> json) {
    return UserDataModel(
      ...
      miniAuctionLiteClassicPlayed: json['mini_auction_lite_classic_played'] ?? 0,
      miniAuctionLitePremiumPlayed: json['mini_auction_lite_premium_played'] ?? 0,
      miniAuctionLiteElitePlayed: json['mini_auction_lite_elite_played'] ?? 0,
      miniAuctionLiteRoyalPlayed: json['mini_auction_lite_royal_played'] ?? 0,
